...
// Some regional Riot feeds publish gameplay several minutes behind the broadcast.
// Frames inside this wider window remain context-only because safe live analysis still
// requires freshness === 'fresh'. Anything beyond this window is genuinely stale.
export const DEGRADED_FRAME_SECONDS = 600;
