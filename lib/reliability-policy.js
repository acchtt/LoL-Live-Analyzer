...
// Some regional Riot feeds publish gameplay a few minutes behind the broadcast.
// Frames inside this window remain context-only because safe live analysis still
// requires freshness === 'fresh'.
export const DEGRADED_FRAME_SECONDS = 300;
